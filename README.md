...
`LeaveFlow` `FoodieSpace` `AI Automation Tools` `Client Projects`
...
`Docker` `AWS` `Azure` `System Design` `Microservices`
...
I'm a **Full Stack Developer** who specializes in scalable web applications, AI-powered products, and clean, modern frontend experiences backed by solid backend architecture.

I like solving real-world problems with practical technology — and I'm always picking up new tools along the way.
...
**🧠 Aura AI** — *AI Sentiment Analysis Platform*
...
**📄 Resume Toolkit** — *Interactive Resume Builder*
...
**📸 Polaroid Topaz** — *Creative Gallery UI*
...
**💬 Eswar Chatbot** — *Conversational AI Chatbot*
...
`AI Podcaster` · `AI Rasibalan` · `Speak to Slides` · `Chat to Website` · `Business Websites`
`Portfolio Websites` · `Landing Pages` · `Automation Tools` · `Client-Focused Delivery`
...
<img src="https://github-profile-trophy.vercel.app/?username=WhisperedCloud&theme=algolia&no-frame=true&column=7&margin-w=8&margin-h=8" width="90%"/>
...
`IBM Generative AI` · `AWS Generative AI` · `Elements of AI` · `Full Stack Development`
`Figma` · `UI / UX` · `Prompt Engineering`
